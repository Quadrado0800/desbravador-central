...
print(f"[config] Desktop path: {DESKTOP}")
FICHA_HOSPEDES_PATH = DESKTOP / "Ficha_Hospedagem.docx"
INFORMATIVOS_PATH = DESKTOP / "Informativos_Hospedagem.docx"
print(f"[config] Ficha-Hospedes path: {FICHA_HOSPEDES_PATH}")
print(f"[config] Informativos path: {INFORMATIVOS_PATH}")
...
def imprimir_checkin(reserva, printer_name=None, print_settings=None):
    ...
    for _ in range(quantidade):
        ...
        if settings["print_informativos"]:
            imprimir_docx(opcional(INFORMATIVOS_PATH,"Informativos_Hospedagem"), printer_name=printer_name)
            impressos.append("Informativos_Hospedagem")
